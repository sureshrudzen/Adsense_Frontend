                        ...
                        <div className="p-2">
                            {countries.map((c) => (
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-2 rounded-md text-sm transition-colors duration-150 flex items-center justify-between hover:bg-gray-100 dark:hover:bg-gray-700 ${selectedCountries.includes(c)
